...
# Requisitos previos
Para que funcione el script, hay que preparar dos carpetas: una que se llama "outputs" y la otra "raw_txt_clean". Debería guardar los archivos que se van a procesar en la carpeta "raw_txt_clean" 
